...
/**
 * Represents a basic detectable part of the input that may be [ignored] during parsing. Parses to
 * [TokenMatch]. The [name] only provides additional information.
 */
public abstract class Token(public var name: String? = null, public val ignored: Boolean) :
    Parser<TokenMatch> {
  ...
  private tailrec fun tryParseImpl(
...
public val noneMatched: Token =
    object : Token("no token matched", false) {
